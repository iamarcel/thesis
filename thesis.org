...
*** Cleaning and Normalizing the Data
    ...
    *Normalizing.*
    ...
    the Cartesian coordinates. Note that when axes are specified, this is in the
    reference coordinate system of the poses returned from 3D Pose Baseline, not
    the coordinate system used in the NAOqi software.
    ...
    #+BEGIN_SRC latex
      \begin{figure}
        \begin{tabular}{ >{\centering\arraybackslash} m{70mm} >{\centering\arraybackslash} m{70mm} }
          ...
          \multicolumn{2}{c}{\includegraphics[width=65mm]{./img/nao-angles-head.png}} \\
          \multicolumn{2}{c}{(c) Head angles}
        \end{tabular}
        \caption{\label{fig:nao-angles} Angle definitions for the NAO robot. The 3D
          pose data is converted from Cartesian coordinates into a representation
