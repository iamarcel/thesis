...
** Conclusion
   ...
   and time-series data processing; in cref:sec:research-dataset the
   available data was examined and the tools to create a dataset for this
   problem were outlined; finally, in cref:sec:research-clustering
...
* A Modern Approach to Gesture Synthesis
  ...
  live robot. An overview of this pipeline is shown in cref:fig:pipeline.
...
**** Results
     ...
     cref:sec:video-picker, collecting more data is time-consuming but
     straightforward.
